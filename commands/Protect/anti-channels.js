    ...
    if(arr[0] == 'FR_fr') {
        ...
        message.channel.send({
            embeds: [{
                color: `#c48206`,
                title: `Statut: \`${statut}\``,
                description: `\`🔘\` **Activer/Désactiver l'anti-salons**`,
                author: {
                            ...
                            if(array[0] == 'enable') {
                                ...
                                msg.edit({
                                    embeds: [{
                                        color: `#c48206`,
                                        title: `Statut: \`❌\``,
                                        description: `\`🔘\` **Activer l'anti-salons**`,
                                        author: {
                                            name: `${message.author.tag}`,
                                            icon_url: `${message.author.avatarURL()}`,
                                        }, 
                                ...
                                msg.edit({
                                    embeds: [{
                                        color: `#c48206`,
                                        title: `Statut: \`✅\``,
                                        description: `\`🔘\` **Désactiver l'anti-salons**`,
                                        author: {
                                            name: `${message.author.tag}`,
                                            icon_url: `${message.author.avatarURL()}`,
                                        }, 
        ...
        message.channel.send({
            embeds: [{
                color: `#c48206`,
                title: `Statut: \`${statut}\``,
                description: `\`🔘\` **Enable/Disable anti-channels**`,
                author: {
                    name: `${message.author.tag}`,
                    icon_url: `${message.author.avatarURL()}`,
                }, 
                            ...
                            if(array[0] == 'enable') {
                                ...
                                msg.edit({
                                    embeds: [{
                                        color: `#c48206`,
                                        title: `Statut: \`❌\``,
                                        description: `\`🔘\` **Enable anti-channels**`,
                                        author: {
                                            name: `${message.author.tag}`,
                                            icon_url: `${message.author.avatarURL()}`,
                                        }, 
                                ...
                                msg.edit({
                                    embeds: [{
                                        color: `#c48206`,
                                        title: `Statut: \`✅\``,
                                        description: `\`🔘\` **Disable anti-channels**`,
                                        author: {
                                            name: `${message.author.tag}`,
                                            icon_url: `${message.author.avatarURL()}`,
                                        }, 
